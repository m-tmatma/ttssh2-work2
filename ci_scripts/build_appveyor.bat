...
set ZIP_FILE=snapshot-%VERSION%-%REVISION%-%DATE%_%TIME%-appveyor-%COMPILER_FRIENDLY%.zip
set SETUP_FILE=snapshot-%VERSION%-%REVISION%-%DATE%_%TIME%-appveyor-%COMPILER_FRIENDLY%
set SNAPSHOT_DIR=snapshot-%REVISION%-%DATE%_%TIME%-appveyor-%COMPILER_FRIENDLY%

...
mkdir %SNAPSHOT_DIR%\cygwin\cygterm\cygterm+-i686
mkdir %SNAPSHOT_DIR%\cygwin\cygterm\cygterm+-x86_64
copy /Y "Release\cygterm.exe"                                                  "%SNAPSHOT_DIR%\cygwin\cygterm\cygterm+-i686\cygterm.exe"
copy /Y "cygwin\cygterm_build\cygterm_build\build_cygterm_x86_64\cygterm.exe"  "%SNAPSHOT_DIR%\cygwin\cygterm\cygterm+-x86_64\cygterm.exe"
